...
<ul class="navbar-nav ms-md mx-auto gap-2">
    <li class="nav-item rounded">
        ...
        <router-link to="/user" class="nav-link"><i class="bi bi-house-fill me-2"></i>Home</router-link>
    </li>
    <li class="nav-item rounded">
    ...
    <li class="nav-item rounded">
        ...
        <router-link to="/user/summary" class="nav-link"><i class="bi bi-book-half me-2"></i>Summary</router-link>
    </li>
